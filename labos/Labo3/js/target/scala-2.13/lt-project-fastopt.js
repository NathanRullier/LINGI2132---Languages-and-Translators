...
class $c_LDSL_Canvasy extends $c_O {
  constructor(canvas) {
    ...
    while (true) {
      ...
      while (true) {
        const arg1 = i$2;
        new $c_LDSL_Square(v1, arg1, 10, $m_LDSL_TileType$().LDSL_TileType$__f_Empty, 0);
        if ((i$2 === 79)) {
          break
        };
        i$2 = ((1 + i$2) | 0)
  ...
  initRender__Lorg_scalajs_dom_raw_HTMLCanvasElement__V(canvas) {
    ...
    const head = new $c_LDSL_Square(0, 0, 40, $m_LDSL_TileType$().LDSL_TileType$__f_Empty, 0);
  ...
  renderHead__LDSL_Square__V(square) {
    ...
    const x = square.LDSL_Square__f_tileType;
    const x$2 = $m_LDSL_TileType$().LDSL_TileType$__f_Empty;
    let style;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      style = "#d1d1e0"
    } else {
      const x$3 = square.LDSL_Square__f_tileType;
      const x$4 = $m_LDSL_TileType$().LDSL_TileType$__f_SnakeHead;
      let $$x1;
      if (((x$3 === null) ? (x$4 === null) : x$3.equals__O__Z(x$4))) {
        $$x1 = true
      } else {
        const x$5 = square.LDSL_Square__f_tileType;
        const x$6 = $m_LDSL_TileType$().LDSL_TileType$__f_SnakeTail;
        $$x1 = ((x$5 === null) ? (x$6 === null) : x$5.equals__O__Z(x$6))
      };
      if ($$x1) {
        style = "#3366ff"
      } else {
        const x$7 = square.LDSL_Square__f_tileType;
        const x$8 = $m_LDSL_TileType$().LDSL_TileType$__f_Food;
...
class $c_LDSL_Game extends $c_O {
  constructor(canvasy) {
    ...
    this.LDSL_Game__f_blocksEaten = 0;
    ...
    this.LDSL_Game__f_tail = null;
    this.LDSL_Game__f_snake = null;
    this.LDSL_Game__f_canvasy = canvasy;
    this.LDSL_Game__f_numberOfSquaresWidth = 20;
    this.LDSL_Game__f_numberOfSquaresHeight = 20;
    this.LDSL_Game__f_directionDoneInLastSecond = false;
    this.LDSL_Game__f_blocksEaten = 0;
    ...
    this.LDSL_Game__f_win = false;
    this.LDSL_Game__f_compteur = 0;
    this.LDSL_Game__f_GAMESPEED = 20;
    const $$x1 = $m_sci_Seq$();
    const array = [new $c_LDSL_Square(1, 0, 40, $m_LDSL_TileType$().LDSL_TileType$__f_SnakeTail, 0), new $c_LDSL_Square(2, 0, 40, $m_LDSL_TileType$().LDSL_TileType$__f_SnakeTail, 0)];
    this.LDSL_Game__f_tail = $as_sci_Seq($$x1.apply__sci_Seq__sc_SeqOps(new $c_sjsr_WrappedVarArgs(array)));
    this.LDSL_Game__f_snake = new $c_LDSL_Snake(new $c_LDSL_Square(3, 0, 40, $m_LDSL_TileType$().LDSL_TileType$__f_SnakeHead, 0), this.LDSL_Game__f_tail);
    const x = this.LDSL_Game__f_snake.LDSL_Snake__f_head;
  ...
  checkCollisions__V() {
    if (((((this.LDSL_Game__f_snake.LDSL_Snake__f_head.LDSL_Square__f_x <= (-1)) || (this.LDSL_Game__f_snake.LDSL_Snake__f_head.LDSL_Square__f_x >= this.LDSL_Game__f_numberOfSquaresWidth)) || (this.LDSL_Game__f_snake.LDSL_Snake__f_head.LDSL_Square__f_y >= this.LDSL_Game__f_numberOfSquaresHeight)) || (this.LDSL_Game__f_snake.LDSL_Snake__f_head.LDSL_Square__f_y <= (-1)))) {
      ...
      const this$2 = $m_s_Console$();
      const this$3 = this$2.out__Ljava_io_PrintStream();
      this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("GAME OVER\n")
    }
  };
  moveSnake__V() {
    const x = this.LDSL_Game__f_direction;
    ...
    const newYHeadPosition = ((this.LDSL_Game__f_snake.LDSL_Snake__f_head.LDSL_Square__f_y + modifHeight) | 0);
    const newXHeadPosition = ((this.LDSL_Game__f_snake.LDSL_Snake__f_head.LDSL_Square__f_x + modifWidth) | 0);
    const qual$1 = this.LDSL_Game__f_snake;
    const qual$2 = this.LDSL_Game__f_snake.LDSL_Snake__f_head;
    const x$3$2 = qual$2.LDSL_Square__f_size;
    const x$4$2 = qual$2.LDSL_Square__f_tileType;
    const x$5$2 = qual$2.LDSL_Square__f_timer;
    const x$6$2 = new $c_LDSL_Square(newXHeadPosition, newYHeadPosition, x$3$2, x$4$2, x$5$2);
    const x$7$2 = qual$1.LDSL_Snake__f_tail;
    this.LDSL_Game__f_snake = new $c_LDSL_Snake(x$6$2, x$7$2)
  };
  update__D__V(seconds) {
    ...
    this.LDSL_Game__f_canvasy.renderHead__LDSL_Square__V(this.LDSL_Game__f_snake.LDSL_Snake__f_head)
  };
}
...
<<<<<<< HEAD
  initGame__V() {
    ...
    new $c_LDSL_Square(0, 0, 40, $m_LDSL_TileType$().LDSL_TileType$__f_Empty, 0);
...
class $c_LDSL_TileType$ extends $c_s_Enumeration {
  constructor() {
    ...
    this.LDSL_TileType$__f_SnakeHead = null;
    this.LDSL_TileType$__f_SnakeTail = null;
    ...
    const name$1 = (((this.s_Enumeration__f_nextName !== null) && this.s_Enumeration__f_nextName.hasNext__Z()) ? $as_T(this.s_Enumeration__f_nextName.next__O()) : "SnakeHead");
    const i$1 = this.s_Enumeration__f_nextId;
    this.LDSL_TileType$__f_SnakeHead = new $c_s_Enumeration$Val(this, i$1, name$1);
    const name$2 = (((this.s_Enumeration__f_nextName !== null) && this.s_Enumeration__f_nextName.hasNext__Z()) ? $as_T(this.s_Enumeration__f_nextName.next__O()) : "SnakeTail");
    const i$2 = this.s_Enumeration__f_nextId;
    this.LDSL_TileType$__f_SnakeTail = new $c_s_Enumeration$Val(this, i$2, name$2);
    const name$3 = (((this.s_Enumeration__f_nextName !== null) && this.s_Enumeration__f_nextName.hasNext__Z()) ? $as_T(this.s_Enumeration__f_nextName.next__O()) : "Food");
    const i$3 = this.s_Enumeration__f_nextId;
    this.LDSL_TileType$__f_Food = new $c_s_Enumeration$Val(this, i$3, name$3)
  };
}
...
class $c_LDSL_Snake extends $c_O {
  constructor(head, tail) {
    super();
    this.LDSL_Snake__f_head = null;
    this.LDSL_Snake__f_tail = null;
    this.LDSL_Snake__f_completeSnake = null;
    this.LDSL_Snake__f_head = head;
    this.LDSL_Snake__f_tail = tail;
    this.LDSL_Snake__f_completeSnake = $as_sci_Seq(tail.prepended__O__O(head))
  };
  productPrefix__T() {
    return "Snake"
  };
  ...
  productElement__I__O(x$1) {
    switch (x$1) {
      case 0: {
        return this.LDSL_Snake__f_head;
        break
      }
      case 1: {
        return this.LDSL_Snake__f_tail;
        break
      }
      default: {
  ...
  equals__O__Z(x$1) {
    if ((this === x$1)) {
      ...
      const x = this.LDSL_Snake__f_head;
      const x$2 = Snake$1.LDSL_Snake__f_head;
      if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
        const x$3 = this.LDSL_Snake__f_tail;
        const x$4 = Snake$1.LDSL_Snake__f_tail;
...
$c_T2.prototype.$classData = $d_T2;
const $f_sc_IndexedSeqOps__prepended__O__O = (function($thiz, elem) {
...
class $c_LDSL_Square extends $c_O {
  constructor(x, y, size, tileType, timer) {
    super();
    this.LDSL_Square__f_x = 0;
    this.LDSL_Square__f_y = 0;
    this.LDSL_Square__f_size = 0;
    this.LDSL_Square__f_tileType = null;
    this.LDSL_Square__f_timer = 0;
    this.LDSL_Square__f_color = null;
    this.LDSL_Square__f_strokeWidth = 0;
    this.LDSL_Square__f_x = x;
    this.LDSL_Square__f_y = y;
    this.LDSL_Square__f_size = size;
    this.LDSL_Square__f_tileType = tileType;
    this.LDSL_Square__f_timer = timer;
  ...
  productElement__I__O(x$1) {
    switch (x$1) {
      ...
      case 2: {
        return this.LDSL_Square__f_size;
        break
      }
      case 3: {
        return this.LDSL_Square__f_tileType;
        break
      }
      case 4: {
        return this.LDSL_Square__f_timer;
        break
      }
      default: {
        return $m_sr_Statics$().ioobe__I__O(x$1)
  ...
  equals__O__Z(x$1) {
    if ((this === x$1)) {
      ...
      if (((((this.LDSL_Square__f_x === Square$1.LDSL_Square__f_x) && (this.LDSL_Square__f_y === Square$1.LDSL_Square__f_y)) && (this.LDSL_Square__f_size === Square$1.LDSL_Square__f_size)) && (this.LDSL_Square__f_timer === Square$1.LDSL_Square__f_timer))) {
        const x = this.LDSL_Square__f_tileType;
        const x$2 = Square$1.LDSL_Square__f_tileType;
        return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
      } else {
        return false
      }
...
const $f_sc_StrictOptimizedSeqOps__prepended__O__O = (function($thiz, elem) {
