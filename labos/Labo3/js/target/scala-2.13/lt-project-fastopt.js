...
class $c_Lwebapp_Main$ extends $c_O {
  initGame__V() {
    ...
    snake.LDSL_Square__f_color = property$1.LDSL_Color__f_c;
    ...
    $m_LDSL_UserInputs$().LDSL_UserInputs$__f_onLeftKeyPressed = new $c_sjsr_AnonFunction0(((this$3, direction$1) => (() => {
    ...
    $m_LDSL_UserInputs$().LDSL_UserInputs$__f_onDownKeyPressed = new $c_sjsr_AnonFunction0(((this$4, direction$4) => (() => {
      direction$4.sr_ObjectRef__f_elem = $m_LDSL_Direction$().LDSL_Direction$__f_Down
    }))(this, direction));
    $m_LDSL_UserInputs$().initInputsListener__V();
    const movement = new $c_sjsr_AnonFunction0(((this$5, direction$5, snake$1, pixelSize) => (() => {
    ...
    const update = new $c_sjsr_AnonFunction0(((this$6$1, compteur$1, GameSpeed$1, movement$1) => (() => {
    ...
    const render = new $c_sjsr_AnonFunction0(((this$7, canvasy$1) => (() => {
      canvasy$1.draw__V()
    }))(this, canvasy));
