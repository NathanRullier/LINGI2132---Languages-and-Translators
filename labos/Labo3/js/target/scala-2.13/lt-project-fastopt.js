...
const $d_LDSL_CollisionHandler$ = new $TypeData().initClass({
  LDSL_CollisionHandler$: 0
}, false, "DSL.CollisionHandler$", {
  LDSL_CollisionHandler$: 1,
  O: 1
});
$c_LDSL_CollisionHandler$.prototype.$classData = $d_LDSL_CollisionHandler$;
let $n_LDSL_CollisionHandler$ = (void 0);
function $m_LDSL_CollisionHandler$() {
  if ((!$n_LDSL_CollisionHandler$)) {
    $n_LDSL_CollisionHandler$ = new $c_LDSL_CollisionHandler$()
  };
  return $n_LDSL_CollisionHandler$
}
...
const $f_LDSL_Settings__$init$__V = (function($thiz) {
  $thiz.LDSL_Canvasy__f_GameSpeed = 8;
  $thiz.LDSL_Canvasy__f_NumberOfSquaresWidthSnake = 20;
  $thiz.LDSL_Canvasy__f_NumberOfSquaresHeightSnake = 20;
  $thiz.LDSL_Canvasy__f_BasicSnakeLength = 3;
  $thiz.LDSL_Canvasy__f_pixelSize = 40;
  $thiz.LDSL_Canvasy__f_SnakeLengthToWin = (($imul($thiz.LDSL_Canvasy__f_NumberOfSquaresWidthSnake, $thiz.LDSL_Canvasy__f_NumberOfSquaresHeightSnake) / 2) | 0)
});
...
class $c_LDSL_UserInputs$ extends $c_O {
  ...
  initInputsListener__V() {
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().addEventListener("keydown", ((arg1$2) => {
      $m_LDSL_UserInputs$().DSL$UserInputs$$$anonfun$initInputsListener$1__Lorg_scalajs_dom_raw_KeyboardEvent__V(arg1$2)
    }), false)
  };
  DSL$UserInputs$$$anonfun$initInputsListener$1__Lorg_scalajs_dom_raw_KeyboardEvent__V(e) {
...
class $c_Lwebapp_Main$ extends $c_O {
  initGame__V() {
    ...
    const update = new $c_sjsr_AnonFunction0(((this$7$1, compteur$1, GameSpeed$1, movement$1, snake$2, background$1, newSnake$1, direction$6, food$1, snakeGridWidth, pixelSize$2, snakeGridHeight) => (() => {
      ...
      if (($intMod(compteur$1.sr_IntRef__f_elem, GameSpeed$1.sr_IntRef__f_elem) === 0)) {
        ...
        if ($$x3.collisionObjxBorders__LDSL_Shape__LDSL_Shape__Z($as_LDSL_Shape($f_sc_LinearSeqOps__apply__I__O(this$11, 0)), background$1)) {
        ...
        const this$13 = $$x4.slice__I__I__sci_List(1, this$12.length__I());
        let these = this$13;
        while ((!these.isEmpty__Z())) {
          ...
          if ((x$6 !== null)) {
            ...
            if ($$x5.perfectCollisionObjxObj__LDSL_Shape__LDSL_Shape__Z($as_LDSL_Shape($f_sc_LinearSeqOps__apply__I__O(this$14, 0)), x$6)) {
              snake$2.LDSL_ComposedShape__f_l = $as_sci_List(newSnake$1.apply__O());
              direction$6.sr_ObjectRef__f_elem = $m_LDSL_Direction$().LDSL_Direction$__f_Right
            }
          } else {
        ...
        const $$x6 = $as_LDSL_Square($as_LDSL_Shape($f_sc_LinearSeqOps__apply__I__O(this$15, 0))).LDSL_Square__f_x;
        const this$16 = snake$2.LDSL_ComposedShape__f_l;
        if ($$x7.perfectCollisionObjxObj__I__I__I__I__Z($$x6, $as_LDSL_Square($as_LDSL_Shape($f_sc_LinearSeqOps__apply__I__O(this$16, 0))).LDSL_Square__f_y, food$1.LDSL_Square__f_x, food$1.LDSL_Square__f_y)) {
          const this$18 = $m_s_Console$();
          const this$19 = this$18.out__Ljava_io_PrintStream();
          this$19.java$lang$JSConsoleBasedPrintStream$$printString__T__V("menoum\n");
          const this$20 = $m_s_util_Random$();
          food$1.LDSL_Square__f_x = $imul(this$20.s_util_Random__f_self.nextInt__I__I(snakeGridWidth), pixelSize$2);
          const this$21 = $m_s_util_Random$();
          food$1.LDSL_Square__f_y = $imul(this$21.s_util_Random__f_self.nextInt__I__I(snakeGridHeight), pixelSize$2);
          ...
          const tail = new $c_LDSL_Square($$x8, $as_LDSL_Square($as_LDSL_Shape($f_sc_LinearSeqOps__apply__I__O(this$23, 0))).LDSL_Square__f_y, pixelSize$2);
          snake$2.addLast__LDSL_Shape__V(tail)
        }
      }
    }))(this, compteur, GameSpeed, movement, snake, background, newSnake, direction, food, 20, 40, 20));
...
class $c_LDSL_ComposedShape extends $c_O {
  constructor(l) {
    super();
    this.LDSL_ComposedShape__f_l = null;
    this.LDSL_ComposedShape__f_l = l
  };
  removeLast__V() {
    const $$x1 = this.LDSL_ComposedShape__f_l;
    const this$1 = this.LDSL_ComposedShape__f_l;
    this.LDSL_ComposedShape__f_l = $$x1.take__I__sci_List((((-1) + this$1.length__I()) | 0))
  };
  addFirst__LDSL_Shape__V(shape) {
  ...
  productElement__I__O(x$1) {
    return ((x$1 === 0) ? this.LDSL_ComposedShape__f_l : $m_sr_Statics$().ioobe__I__O(x$1))
  };
  productIterator__sc_Iterator() {
    return new $c_sr_ScalaRunTime$$anon$1(this)
  };
  ...
  equals__O__Z(x$1) {
    if ((this === x$1)) {
      return true
    } else if ((x$1 instanceof $c_LDSL_ComposedShape)) {
      const ComposedShape$1 = $as_LDSL_ComposedShape(x$1);
      const x = this.LDSL_ComposedShape__f_l;
      const x$2 = ComposedShape$1.LDSL_ComposedShape__f_l;
...
function $as_LDSL_ComposedShape(obj) {
  return (((obj instanceof $c_LDSL_ComposedShape) || (obj === null)) ? obj : $throwClassCastException(obj, "DSL.ComposedShape"))
}
function $isArrayOf_LDSL_ComposedShape(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LDSL_ComposedShape)))
}
function $asArrayOf_LDSL_ComposedShape(obj, depth) {
  return (($isArrayOf_LDSL_ComposedShape(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LDSL.ComposedShape;", depth))
}
const $d_LDSL_ComposedShape = new $TypeData().initClass({
  LDSL_ComposedShape: 0
}, false, "DSL.ComposedShape", {
  LDSL_ComposedShape: 1,
  O: 1,
  LDSL_Shape: 1,
  s_Product: 1,
  s_Equals: 1,
...
class $c_LDSL_Square extends $c_O {
  ...
  moveX__I__V(v) {
    this.LDSL_Square__f_x = ((this.LDSL_Square__f_x + v) | 0)
  };
  moveY__I__V(v) {
