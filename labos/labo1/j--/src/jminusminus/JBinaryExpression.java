...
class JModuloOp extends JBinaryExpression {
	...
	/**
	 * Construct an AST for a modulo expression given its line number, and
	 * the lhs and rhs operands.
	 * 
	 * @param line line in which the modulo expression occurs in the source
	 *             file.
	 * @param lhs  the lhs operand.
	 * @param rhs  the rhs operand.
	 */
...
class JDivideOp extends JBinaryExpression {
	/**
	 * Construct an AST node for a division expression given its line number, and
	 * the lhs and rhs operands.
	 *
